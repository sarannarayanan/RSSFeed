...
def rss():
    item1 = Item(
        ...
        description = "Create Flow Local Actions Using Aura Components. <speak>    <say-as interpret-as="spell-out">Check out the developer docs in alexa app</say-as> </speak> ",
